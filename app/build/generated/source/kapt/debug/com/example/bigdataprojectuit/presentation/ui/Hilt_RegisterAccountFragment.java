 ...
 */
public abstract class Hilt_RegisterAccountFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RegisterAccountFragment() {
    super();
  }

  Hilt_RegisterAccountFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RegisterAccountFragment_GeneratedInjector) this.generatedComponent()).injectRegisterAccountFragment(UnsafeCasts.<RegisterAccountFragment>unsafeCast(this));
    }
  }
